...
export interface SpecialAchievements {
...
export const interpretations: Interpretations = {
  score_interpretations: {
    "0-10": "Freshly landed in Namma Bengaluru! You probably still call it 'Bengaluru' and haven't experienced a proper traffic jam yet.",
    ...
    "61-70": "Bengaluru Tech Veteran: You've been through multiple startup pivots and have a favorite filter coffee place in every tech hub.",
    "71-80": "Elite Bengaluru Techie: You've lived in all the startup hubs and have strong opinions about every co-working space.",
    "81-90": "Bengaluru Tech Guru: You're probably running a startup or have had multiple failed ones. You judge people by their choice of coffee place.",
  ...
  special_achievements: {
    ...
    coffee_expert: "Coffee Connoisseur: Worked from every major coffee chain in Bengaluru",
