...
export const bingoQuestions: BangaloreTechBingo = {
  questions: [
    "Applied to a job at Microsoft/Amazon/Google in their Bangalore office",
    "Been asked 'which IIT/NIT are you from?'",
    "Said 'I'm from tier 2 college but...'",
    "Attended a Bangalore Open Coffee Club meetup",
    ...
    "Complained about Bangalore traffic in a standup",
    ...
    "Posted about Bangalore weather on social media",
    "Compared Bangalore & Hyderabad tech scenes",
    ...
    "Attended Reddit Bangalore meetup",
    ...
    "Attended Python Bangalore meetup",
    ...
    "Attended Angular Bangalore meetup",
    ...
    "Attended AI/ML Bangalore meetup",
    ...
    "Attended Startup Weekend Bangalore",
    ...
    "Used LinkedIn local Bangalore events",
